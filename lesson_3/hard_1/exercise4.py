...
# Return a false condition. Handle case where input isn't 4 components (invalid)
def is_dot_separated_ip_address(input_string):
    dot_separated_words = input_string.split(".")
...
print(is_dot_separated_ip_address('1000.-4.5.11')) # => False
print(is_dot_separated_ip_address('a.b.c.d'))      # => False
